...
SYSTEM_PROMPT = (
    ...
    "8. Always provide 3 to 5 options with icon suggestions. Option labels must be at most 4 words "
    "and descriptions at most 8 words — terse phrases, never full sentences (e.g. label 'Mostly at a desk', "
    "description 'External monitor, rarely moves'). The question itself stays under 14 words.\n"
