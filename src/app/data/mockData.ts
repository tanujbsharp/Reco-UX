...
const createLaptopIllustration = ({
  ...
  const svg = `
    <svg width="1600" height="1100" viewBox="0 0 1600 1100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M450 590H1150" stroke="rgba(255,255,255,0.32)" stroke-width="2"/>
      <text x="450" y="648" fill="white" font-size="74" font-family="Inter, Arial, sans-serif" font-weight="700">${label}</text>
      <text x="452" y="708" fill="rgba(255,255,255,0.82)" font-size="28" font-family="Inter, Arial, sans-serif">Bsharp mock visual • premium Mac lineup</text>
...
export const mockProducts: Product[] = [
  {
    ...
    fitSummary: "A lightweight Mac that covers study, browsing, documentation, and light creative work without feeling underpowered.",
    whyRecommended:
      "This is the cleanest match if you want a premium Mac that is easy to carry, boots instantly, stays silent, and still feels fast for daily work.",
    matchScore: 96,
    ...
    cons: [
      ...
      "Port selection is more limited than MacBook Pro",
    ],
    implications: [
    ...
    documents: [
      ...
      { label: "Warranty", value: "1-year limited warranty + AppleCare+ option" },
    ],
    salespersonTips: [
  ...
  },
  {
    ...
    fitSummary: "This is the most balanced Mac if you want extra ports, better thermals, and a much richer display without jumping straight to an expensive maxed-out Pro.",
    whyRecommended:
  ...
  },
  {
    ...
    whyRecommended:
      "If you want this Mac to stay comfortable with heavier creative workflows for years, the extra RAM and Pro-class headroom make a visible difference.",
    matchScore: 87,
    ...
    salespersonTips: [
      ...
      "A massive 1TB SSD means you can store huge files and apps directly on your Mac without external drives.",
    ],
    specs: [
  ...
  },
  {
    ...
    cons: [
      "Not the easiest Mac to carry daily",
...
export const mockQuestions: Question[] = [
  {
    id: "q1",
    type: "single-choice",
    question: "What will this Mac mainly be used for?",
    autoAdvance: true,
    options: [
      {
...
export const mockVoiceTranscriptions = {
  hindi:
    "मुझे एक MacBook चाहिए जो रोज carry करने में हल्का हो। मैं coding भी करता हूँ और battery life strong चाहिए। 14 inch और 13 inch के बीच confused हूँ।",
  english:
    "I need a MacBook that is easy to carry every day. I do coding, a bit of design work, and I care a lot about battery life. I am deciding between a 13-inch and a 14-inch machine.",
  mixed:
    "Mujhe daily carry ke liye ek MacBook chahiye. Coding karta hoon, battery strong honi chahiye, and I think 14-inch Pro ya lightweight Air dono dekhna hai.",
};
...
export const mockCommentary = {
  ...
  processing:
    "We are combining your open-input signals with the structured answers to rank the strongest Mac fits.",
  recommendations:
    "These Mac recommendations balance portability, battery, screen size, and workflow fit. Use the commentary rail to understand why each option stood out.",
  comparison:
    "Comparing two Macs side by side makes the trade-offs concrete: carry weight versus screen size, silent design versus thermal headroom, and value versus future-proofing.",
  productDetail:
